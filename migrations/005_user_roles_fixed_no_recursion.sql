-- Roles and Permissions Migration - Fixed Infinite Recursion
-- This version fixes the infinite recursion issue in the RLS policies
...
-- IMPORTANT: Create a separate managers view to avoid recursion in RLS policies
