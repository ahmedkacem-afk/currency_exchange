...
const strings = {
  en: {
    ...
    "exchangeRates.subtitle": "Manage exchange rates for all currencies",
    "exchangeRates.currency": "Currency",
    "exchangeRates.rateToUsd": "Rate to USD",
    "exchangeRates.rateToLyd": "Rate to LYD",
    "exchangeRates.actions": "Actions",
    "exchangeRates.save": "Save",
    "exchangeRates.noRates": "No exchange rates configured",
    "exchangeRates.updated": "Exchange rate updated successfully",
    "exchangeRates.failed": "Failed to save exchange rate",
    "exchangeRates.loading": "Loading exchange rates...",
    "exchangeRates.info": "Exchange Rate Information",
    "exchangeRates.usdAlways1": "USD rate to USD is always 1.0",
    "exchangeRates.lydAlways1": "LYD rate to LYD is always 1.0",
    "exchangeRates.otherCurrencies": "All other currencies should have their rates relative to USD and LYD",
    "exchangeRates.example": "Example: If EUR = 1.1 USD, then EUR rate to USD = 1.1",
    "exchangeRates.current": "Current Exchange Rates",
    "exchangeRates.toUsd": "to USD",
    "exchangeRates.toLyd": "to LYD",
    ...
    dashboard: {
      ...
      usd: "USD",
      lyd: "LYD",
      buyInfo: "Buying Dinar",
      sellInfo: "Selling Dinar",
      lowest: "Lowest",
      median: "Median",
      highest: "Highest",
      managerPrices: "Manager Prices",
      sellold: "Selling old dinar",
      sellnew: "Selling new dinar",
      buyold: "Buying old dinar",
      buynew: "Buying new dinar",
      save: "Save Prices",
    },
    withdrawals: {
      title: "Withdrawals & Reports",
    ...
    create: {
      ...
      currencyType: "Create Currency Type",
  ...
  ar: {
    ...
    "exchangeRates.title": "أسعار الصرف",
    "exchangeRates.subtitle": "إدارة أسعار الصرف لجميع العملات",
    "exchangeRates.currency": "العملة",
    "exchangeRates.rateToUsd": "السعر بالدولار",
    "exchangeRates.rateToLyd": "السعر بالدينار",
    "exchangeRates.actions": "الإجراءات",
    "exchangeRates.save": "حفظ",
    "exchangeRates.noRates": "لم يتم تكوين أسعار صرف",
    "exchangeRates.updated": "تم تحديث سعر الصرف بنجاح",
    "exchangeRates.failed": "فشل في حفظ سعر الصرف",
    "exchangeRates.loading": "جاري تحميل أسعار الصرف...",
    "exchangeRates.info": "معلومات أسعار الصرف",
    "exchangeRates.usdAlways1": "سعر الدولار بالدولار هو دائماً 1.0",
    "exchangeRates.lydAlways1": "سعر الدينار بالدينار هو دائماً 1.0",
    "exchangeRates.otherCurrencies": "يجب أن تكون جميع العملات الأخرى بأسعارها بالنسبة للدولار والدينار",
    "exchangeRates.example": "مثال: إذا كان EUR = 1.1 USD، فإن سعر EUR بالدولار = 1.1",
    "exchangeRates.current": "أسعار الصرف الحالية",
    "exchangeRates.toUsd": "بالدولار",
    "exchangeRates.toLyd": "بالدينار",
    ...
    dashboard: {
      totals: "الإجماليات",
      totalUsd: "إجمالي الدولار",
      totalLyd: "إجمالي الدينار",
      numWallets: "عدد المحافظ",
      selectWallet: "اختر المحفظة",
      walletBalances: "أرصدة المحفظة",
      usd: "دولار",
      lyd: "دينار",
      buyInfo: "معلومات شراء الدينار",
      sellInfo: "معلومات بيع الدينار",
      lowest: "الأدنى",
      median: "الوسطي",
      highest: "الأعلى",
      managerPrices: "أسعار المدير",
      sellold: "بيع الدينار القديم",
      sellnew: "بيع الدينار الجديد",
      buyold: "شراء الدينار القديم",
      buynew: "شراء الدينار الجديد",
      save: "حفظ الأسعار",
    },
    withdrawals: {
    ...
    create: {
      title: "إنشاء الكيانات",
      wallet: "إنشاء محفظة",
      name: "الاسم",
      initUsd: "الدولار الابتدائي",
      initLyd: "الدينار الابتدائي",
      create: "إنشاء",
      user: "إنشاء مستخدم",
      email: "البريد الإلكتروني",
      phone: "الهاتف",
      password: "كلمة المرور",
      operation: "إنشاء نوع معاملات",
      operationName: "اسم المعاملة",
      currencyType: "إنشاء نوع عملة",
      currencyCode: "رمز العملة",
      currencyName: "اسم العملة",
      currencySymbol: "رمز العملة (اختياري)",
