...
export default function BuyCurrencyPage() {
  ...
  }, [formData.receiveCurrencyCode, formData.payCurrencyCode, prices])
              ...
              <div className="bg-blue-100 p-4 rounded-lg border border-blue-200 mt-4">
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium">
                      {formData.price || '0.00'} {formData.payCurrencyCode ? `${formData.payCurrencyCode}/${formData.receiveCurrencyCode}` : ''}
                    </span>
                  </div>
